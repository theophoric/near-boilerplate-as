...
//     Runtime,
//     Account
//   } from "near-sdk-simulator";

  
//   const WASM_FILE = file + "../../../../out/debug/01.greeting.wasm";
...
//     let userAccounts: Array<Account>;
  
//     beforeAll(() => {
//       runtime = new Runtime();
//       contract = runtime.newAccount("greeting", WASM_FILE);
//       contract.call("new", "TEST");
//       userAccounts = users
